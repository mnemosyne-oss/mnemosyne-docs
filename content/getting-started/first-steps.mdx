...
You've learned the core CRUD operations. Next, explore the [BEAM Architecture](/docs/architecture/beam-overview) to understand how Mnemosyne organizes memory.
</Callout>
