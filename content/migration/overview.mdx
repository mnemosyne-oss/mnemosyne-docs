...
Mnemosyne v2.2 ships importers for 6 major memory providers. Each importer handles extraction, field mapping, and data import end to end. You don't need to write export scripts or manually map fields.
...
# Generate documentation for writing your own importer
hermes mnemosyne import --from zep --generate-docs
```
