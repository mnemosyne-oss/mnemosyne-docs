...
Encryption at rest (AES-256-GCM or equivalent) is not yet implemented in the Mnemosyne constructor. The `Mnemosyne()` class does not accept an `encryption_key` parameter. This page documents the planned feature. Use filesystem-level encryption in the meantime.
</Callout>
