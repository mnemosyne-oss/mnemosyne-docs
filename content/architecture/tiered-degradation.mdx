export const metadata = {
  ...
  description: 'Mnemosyne v2.3 introduces three-tier degradation so episodic memories persist indefinitely without bloat. Hot, warm, and cold tiers keep old memories queryable at reduced priority.',
...
Mnemosyne v2.3 introduces three-tier degradation so episodic memories persist indefinitely without bloat. Old memories never get deleted, they gracefully fade into compact, lower-priority signals that still surface when the query really matters.
