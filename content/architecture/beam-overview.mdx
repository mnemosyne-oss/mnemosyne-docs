...
| `memoria_instructions` | Extracted user instructions | instruction_text, context_snippet |
| `memoria_preferences` | User preference statements | preference_key, preference_value |
