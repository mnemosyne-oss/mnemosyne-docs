...
| **MCP** | 23 tools, stdio + SSE | Custom HTTP API |
...
*This page was rewritten for v3.4.0 after community feedback about inaccurate comparisons. Every feature listed for Mnemosyne has been verified against the source code. If anything here is wrong, please open an issue — we'll fix it.*
