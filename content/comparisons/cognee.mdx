...
**Last updated:** 2026-06-08 · Mnemosyne v3.4.0 · Cognee OSS (as of May 2026)
...
| **Integrations** | Hermes Agent (native, 15 tools, 3 hooks), MCP (23 tools, stdio + SSE), OpenClaw (planned) | Framework-agnostic Python library; LangChain integration; growing ecosystem |
