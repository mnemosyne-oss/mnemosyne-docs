...
| **Stars / community** | New (v3.1.2) | ~800 GitHub stars, Plastic Labs team |
...
*Every feature listed for Mnemosyne has been verified against the v3.1.2 source code. Honcho features are based on the open-source repository and Plastic Labs documentation as of May 2026. If anything here is wrong, please open an issue -- we'll fix it.*
