...
**Last updated:** 2026-05-05 · Mnemosyne v2.3.0
...
| **Stars / community** | New (v2.3.0) | ~800 GitHub stars, Plastic Labs team |
...
*Every feature listed for Mnemosyne has been verified against the v2.3.0 source code. Honcho features are based on the open-source repository and Plastic Labs documentation as of May 2026. If anything here is wrong, please open an issue -- we'll fix it.*
