...
| **Stars / community** | New (v2.5.0) | ~21.8K GitHub stars, active research community |
| **Pricing** | Free (Apache 2.0) | OSS free (Letta Code), Cloud API $20–$750/mo + usage |
...
*Every feature listed for Mnemosyne has been verified against the v2.5.0 source code. Letta features are based on the open-source repository and documentation as of May 2026. If anything here is wrong, please open an issue -- we'll fix it.*
