...
## Hermes Plugin Tools (17 tools)

<Callout type="info">
The Hermes plugin registers 17 tools. Shared surface tools (`shared_remember`, `shared_recall`, `shared_forget`, `shared_stats`) and `validate`/`get` are MCP-only and not registered by the plugin.
</Callout>
