...
**Last updated:** June 2026 &middot; Mnemosyne v3.11.0
...
| Feature | Status |
|---------|--------|
| Bidirectional delta sync | v3.11.0 |
| Pull-only / push-only modes | v3.11.0 |
| Delta/change-based protocol | v3.11.0 (based on existing DeltaSync) |
| Append-only event log | v3.11.0 |
| Timestamp + importance conflict detection | v3.11.0 |
| API key / JWT authentication | v3.11.0 |
| Optional client-side encryption | v3.11.0 |
| TLS guidance + examples | v3.11.0 |
...
- Mnemosyne v3.11.0+ installed on both instances
