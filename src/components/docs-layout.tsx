      ...
      <header className="h-14 border-b border-border-warm bg-white/80 backdrop-blur-sm flex items-center justify-between px-4 shrink-0 z-30">
        <div className="flex items-center gap-3">
          ...
          <Link href="/" className="hidden lg:flex items-center gap-2 font-serif font-semibold text-charcoal">
            <div className="w-6 h-6 rounded-md bg-charcoal flex items-center justify-center text-cream text-xs font-bold">
              M
            </div>
            Mnemosyne
          </Link>
          ...
          <footer className="border-t border-border-warm py-8 px-6 mt-10">
            <div className="max-w-4xl mx-auto flex flex-col sm:flex-row items-center justify-between gap-4 text-sm text-warm-gray-light">
              <div>
                ...
                <a href="https://github.com/axdsan" className="text-accent-terracotta hover:underline">
                  Abdias Moya
                </a>
                .
              </div>
              <div className="flex items-center gap-4">
                <a href="https://github.com/axdsan/mnemosyne" className="hover:text-warm-gray transition-colors">
                  GitHub
                </a>
                <a href="https://x.com/axdsan" className="hover:text-warm-gray transition-colors">
                  X/Twitter
                </a>
              </div>
            </div>
