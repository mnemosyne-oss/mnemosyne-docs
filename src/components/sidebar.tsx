...
const navigation: NavSection[] = [
  ...
  },
  {
    ...
    icon: <Layers size={16} />,
    items: [
      { title: "BEAM Overview", href: "/docs/architecture/beam-overview" },
      { title: "System Design", href: "/docs/architecture/system-design" },
      { title: "Data Flow", href: "/docs/architecture/data-flow" },
      { title: "Sleep Consolidation", href: "/docs/architecture/sleep-consolidation" },
      { title: "AAAK Compression", href: "/docs/architecture/aaak-compression" },
    ],
  },
  {
    ...
    icon: <Brain size={16} />,
    items: [
      { title: "Working Memory", href: "/docs/memory-systems/working" },
      { title: "Episodic Memory", href: "/docs/memory-systems/episodic" },
      { title: "Semantic Memory", href: "/docs/memory-systems/semantic" },
      { title: "Scratchpad", href: "/docs/memory-systems/scratchpad" },
      { title: "Temporal Graph", href: "/docs/memory-systems/temporal-graph" },
    ],
  },
  {
    title: "Retrieval",
    icon: <Search size={16} />,
    items: [
      { title: "Hybrid Search", href: "/docs/retrieval/hybrid-search" },
      { title: "Vector Search", href: "/docs/retrieval/vector-search" },
      { title: "FTS5 Search", href: "/docs/retrieval/fts5-search" },
      { title: "Ranking & Scoring", href: "/docs/retrieval/ranking" },
    ],
  },
  {
    title: "API",
    ...
    items: [
      ...
      { title: "Hermes Plugin", href: "/docs/api/hermes-plugin" },
      { title: "REST API", href: "/docs/api/rest" },
      { title: "Tool Schema", href: "/docs/api/tool-schema" },
    ],
  },
  {
    title: "Deployment",
    ...
    items: [
      ...
      { title: "Systemd", href: "/docs/deployment/systemd" },
      { title: "Cron Jobs", href: "/docs/deployment/cron" },
    ],
  },
  {
    title: "Operations",
    ...
    items: [
      ...
      { title: "Backups", href: "/docs/operations/backups" },
      { title: "Migration", href: "/docs/operations/migration" },
      { title: "Performance", href: "/docs/operations/performance" },
  ...
  },
  {
    ...
    items: [
      ...
      { title: "Data Privacy", href: "/docs/security/data-privacy" },
    ],
  },
  {
    title: "Use Cases",
    ...
    items: [
      { title: "Overview", href: "/docs/use-cases/overview" },
      { title: "Multi-Agent", href: "/docs/use-cases/multi-agent" },
      { title: "Long-Running", href: "/docs/use-cases/long-running" },
