...
**Last updated:** 2026-05-11 · Mnemosyne v2.5.0
...
| **Stars / community** | New (v2.5.0) | ~800 GitHub stars, Plastic Labs team |
| **License** | Apache 2.0 | AGPL-3.0 (restrictive for commercial use) |
| **Pricing** | Free (Apache 2.0) | Managed service: $100 free credits, $2/million tokens ingestion, reasoning fees per call. Self-hosted: free (but you pay for 3+ LLM provider keys) |
...
- You are building a commercial product and need Apache 2.0 licensing
...
*Every feature listed for Mnemosyne has been verified against the v2.5.0 source code. Honcho features are based on the open-source repository and Plastic Labs documentation as of May 2026. If anything here is wrong, please open an issue -- we'll fix it.*
