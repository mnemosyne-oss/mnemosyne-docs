...
**Last updated:** 2026-06-08 · Mnemosyne v3.4.0 · SuperMemory (as of May 2026)
...
| **MCP** | 23 tools, stdio + SSE | Custom HTTP API via Memory Router |
...
| **Integrations** | Hermes Agent (native, 15 tools, 3 hooks), MCP (23 tools, stdio + SSE), OpenClaw (planned) | Memory Router (OpenAI-compatible proxy), Notion, Slack, Google Drive connectors |
