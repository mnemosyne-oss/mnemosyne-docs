...
| **Integrations** | Hermes Agent (native, 15 tools, 3 hooks), MCP (25 tools, stdio + SSE), OpenClaw (planned) | Memory Router (OpenAI-compatible proxy), Notion, Slack, Google Drive connectors |
