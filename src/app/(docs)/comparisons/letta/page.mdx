...
**Last updated:** 2026-06-08 · Mnemosyne v3.4.0
...
| **Stars / community** | New (v3.4.0) | ~21.8K GitHub stars, active research community |
...
Mnemosyne provides an MCP server with **23 tools** and **2 transports**:
...
| **MCP** | 23 tools, stdio + SSE | Not MCP-native. Tool calls happen server-side inside the agent. |
...
*Every feature listed for Mnemosyne has been verified against the v3.4.0 source code. Letta features are based on the open-source repository and documentation as of May 2026. If anything here is wrong, please open an issue -- we'll fix it.*
