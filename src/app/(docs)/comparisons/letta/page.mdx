...
**Last updated:** 2026-05-13 · Mnemosyne v3.0.0
...
| **Stars / community** | New (v3.0.0) | ~21.8K GitHub stars, active research community |
...
*Every feature listed for Mnemosyne has been verified against the v3.0.0 source code. Letta features are based on the open-source repository and documentation as of May 2026. If anything here is wrong, please open an issue -- we'll fix it.*
