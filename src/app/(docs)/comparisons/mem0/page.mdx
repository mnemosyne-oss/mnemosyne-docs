...
**Last updated:** 2026-06-08 · Mnemosyne v3.6.0 · Mem0 Platform (as of May 2026)
...
| **Integrations** | Hermes Agent (native, 15 tools, 3 hooks), MCP (25 tools, stdio + SSE), OpenClaw (planned) | LangChain, LlamaIndex, CrewAI, AutoGen, OpenAI Agents SDK |
...
*Every claim about Mem0 has been verified against their public docs and pricing page (as of May 2026). Every claim about Mnemosyne has been verified against the v3.6.0 source code. If anything here is wrong, please open an issue — we'll fix it.*
