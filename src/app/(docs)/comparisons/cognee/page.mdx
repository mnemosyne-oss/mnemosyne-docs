...
| **Integrations** | Hermes Agent (native, 15 tools, 3 hooks), MCP (25 tools, stdio + SSE), OpenClaw (planned) | Framework-agnostic Python library; LangChain integration; growing ecosystem |
