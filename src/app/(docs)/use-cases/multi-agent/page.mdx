export const metadata = {
  ...
  description: 'Build multi-agent systems with Mnemosyne v2.5: shared memory with per-agent identity, channel-based recall, author filtering, MCP cross-machine sharing, and practical deployment patterns.',
  openGraph: {
    images: ['/og-image.svg'],
  },
  twitter: {
...
## Shared Memory with Identity (v2.3)
