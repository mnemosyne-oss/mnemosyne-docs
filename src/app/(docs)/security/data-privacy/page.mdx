export const metadata = {
  title: 'Data Privacy — Privacy by Default for Agent Memory',
  description: 'Understand Mnemosyne\'s privacy model: local-first storage, data retention via TTL, scope-based isolation, and best practices for privacy-sensitive deployments.',
  openGraph: {
