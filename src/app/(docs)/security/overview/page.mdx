export const metadata = {
  ...
  description: 'Overview of Mnemosyne security: local-first architecture, access control, data privacy, and the design that keeps your agent data safe by default.',
  openGraph: {
    images: ['/og-image.svg'],
  },
  twitter: {
