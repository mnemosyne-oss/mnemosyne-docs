...
- **`mnemosyne_triple_query`** — Query the temporal knowledge graph for facts matching subject/predicate/object patterns.
...
Add a temporal fact triple (subject, predicate, object) to the knowledge graph. Example: ('user', 'prefers', 'neovim'). Use for structured relationships.
