  ...
  "parameters": {
    ...
    "properties": {
      ...
      "author_type": {
        "type": "string",
        "enum": ["human", "agent", "system"],
        "description": "Filter by author category. "
      },
      "channel_id": {
        "type": "string",
        "description": "Filter by channel for cross-session recall. "
      }
    }
  }
}`} language="json" />
...
**All 24 tools** are available via the Hermes Agent plugin. The MCP server exposes a subset (remember, recall, sleep, scratchpad, stats) plus triple tools by name but not by discovery.

> Full tool list: `mnemosyne_remember`, `mnemosyne_recall`, `mnemosyne_shared_remember`, `mnemosyne_shared_recall`, `mnemosyne_shared_forget`, `mnemosyne_shared_stats`, `mnemosyne_sleep`, `mnemosyne_stats`, `mnemosyne_get`, `mnemosyne_forget`, `mnemosyne_update`, `mnemosyne_invalidate`, `mnemosyne_validate`, `mnemosyne_triple_add`, `mnemosyne_triple_end`, `mnemosyne_triple_query`, `mnemosyne_scratchpad_write`, `mnemosyne_scratchpad_read`, `mnemosyne_scratchpad_clear`, `mnemosyne_export`, `mnemosyne_import`, `mnemosyne_diagnose`, `mnemosyne_graph_query`, `mnemosyne_graph_link`.
</Callout>
