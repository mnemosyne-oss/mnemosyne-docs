export const metadata = {
  title: 'AAAK Compression — Text Substitution for Memory Compaction',
  description: 'Understand AAAK compression in Mnemosyne: a text substitution system that reduces memory content size by applying category prefixes, phrase compression, and structural patterns.',
  openGraph: {
    images: ['/og-image.svg'],
  },
  twitter: {
