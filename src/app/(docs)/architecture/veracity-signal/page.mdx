...
Mnemosyne supports a `veracity` field for every memory so you know how trustworthy it is. Not all memories are created equal: something you explicitly stated deserves more weight than something the AI inferred from context.
