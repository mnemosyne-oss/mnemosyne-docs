...
Mnemosyne (since v2.3) supports a `veracity` field to every memory so you know how trustworthy it is. Not all memories are created equal: something you explicitly stated deserves more weight than something the AI inferred from context.
