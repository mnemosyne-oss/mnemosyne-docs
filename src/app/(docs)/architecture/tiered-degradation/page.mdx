export const metadata = {
  ...
  description: 'Mnemosyne (since v2.3) supports three-tier degradation so episodic memories persist indefinitely without bloat. Hot, warm, and cold tiers keep old memories queryable at reduced priority.',
