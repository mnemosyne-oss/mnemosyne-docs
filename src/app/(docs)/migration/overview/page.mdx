...
Mnemosyne v2.3 ships importers for 6 major memory providers. Each importer handles extraction, field mapping, and data import end to end. You don't need to write export scripts or manually map fields.
