---
title: "Mnemosyne Sync - Bidirectional Memory Sync Between Instances"
sidebarTitle: "Sync"
description: "Bidirectional memory sync between local and remote Mnemosyne instances. Delta-based, event-sourced, with optional client-side encryption."
---
...
| Feature | Status |
|---------|--------|
| Bidirectional delta sync | v3.7.0 |
| Pull-only / push-only modes | v3.7.0 |
| Delta/change-based protocol | v3.7.0 (based on existing DeltaSync) |
| Append-only event log | v3.7.0 |
| Timestamp + importance conflict detection | v3.7.0 |
| API key / JWT authentication | v3.7.0 |
| Optional client-side encryption | v3.7.0 |
| TLS guidance + examples | v3.7.0 |
...
- Mnemosyne v3.7.0+ installed on both instances
