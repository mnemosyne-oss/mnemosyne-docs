export const metadata = {
  ...
  description: 'Guide to migrating Mnemosyne data between versions, servers, and storage backends. Covers schema migrations, data transformation, and zero-downtime upgrades.',
  openGraph: {
    images: ['/og-image.svg'],
  },
  twitter: {
