export const metadata = {
  ...
  description: 'Solve common Mnemosyne problems: database locks, slow queries, memory leaks, embedding errors, and connection issues with step-by-step debugging guides.',
  openGraph: {
    images: ['/og-image.svg'],
  },
  twitter: {
