...
Get Mnemosyne v2.0.0 running in under 5 minutes. This guide covers installation, basic configuration, and your first memory operations — including entity extraction and temporal recall.
...
work_mem.remember("Deployed v2.0.0 to staging.")
